  ...
  return (
    <main className="relative min-h-[calc(100vh-73px)] overflow-hidden bg-[#08070B]">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-[20%] -top-[25%] h-[650px] w-[650px] rounded-full bg-[#7C3AED]/[0.14] blur-[150px]" />

        <div className="absolute -bottom-[30%] -right-[15%] h-[600px] w-[600px] rounded-full bg-[#25D366]/[0.055] blur-[150px]" />
        ...
        <div className="hidden lg:block">
          <div className="max-w-xl">
            ...
            <p className="mt-7 max-w-md text-base leading-7 text-white/45">
              Sign in to manage your events, track
              attendees, monitor ticket sales and keep
              everything moving.
            </p>
              ...
              >
                ...
                <label className="block">
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    {/* Keep this empty for now unless a
